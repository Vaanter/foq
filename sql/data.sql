...
VALUES ((SELECT user_id FROM users WHERE username = 'testuser1'), 'C:\', 'c', 'r;l;w;c') ON CONFLICT DO NOTHING;

INSERT INTO views(user_id, root, label, permissions)
VALUES ((SELECT user_id FROM users WHERE username = 'testuser1'), '/', 'root', 'r;l;w;c') ON CONFLICT DO NOTHING;
...
INSERT INTO views(user_id, root, label, permissions)
VALUES ((SELECT user_id FROM users WHERE username = 'testuser3'), 'ROOT', 'LABEL', 'INVALID');